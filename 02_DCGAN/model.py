...
class Generator(nn.Module):
    def __init__(self, z_dim, channels_img, features_g):
        ...
        self.gen = nn.Sequential(
            self._block(z_dim, features_g * 16, 4, 1, 0), # N x f_f*16 x 4 x 4
            self._block(features_g * 16, features_g * 8, 4, 2, 1), # N x f_f*8 x 8 x 8
            self._block(features_g * 8, features_g * 4, 4, 2, 1), # N x f_f*4 x 16 x 16
            self._block(features_g * 4, features_g * 2, 4, 2, 1), # N x f_f*2 x 32 x 32
